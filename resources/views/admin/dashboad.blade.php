...
<html lang="en">
	<head>
		...
		<link rel="stylesheet" type="text/css" href="{{ asset('assets/datatables/jquery.dataTables.min.css') }}">
	...
	<body class="no-skin">
						...
						<li class="light-blue dropdown-modal">
							<a data-toggle="dropdown" href="#" class="dropdown-toggle">
								...
								<span class="user-info">
									<small>Welcome,</small>
									@if (!empty(Auth::user()))
							         xin chào:<b style="color:black">{{ Auth::user()->name }}</b>
							         @endif
								</span>
				...
				<div class="footer-inner">
					<div class="footer-content">
						<span class="bigger-120">
							<span class="blue bolder">VHSHOP</span>
							&copy; vhshop8888@gmail.com
						</span>
		...
		{{-- <script src="{{ asset('assets/js/jquery.min.map') }} "></script> --}}
		...
		<script src="{{ asset('assets/js/ace-extra.min.js') }}"></script>
  		...
  		{{-- <script src="{{ asset('js/bootstrap.bundle.js.map.js') }}"></script> --}}
