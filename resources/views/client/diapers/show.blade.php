...
<div class="clearfix containers">
    ...
    <div style="padding-left: 10px;padding-right: 10px">
            <div class="clearfix backgroundWhite" style="padding-left: 100px ; padding-top: 20px; padding-bottom: 20px">
                <div class="clearfix">{{$diapers->name}}</div>
                <div class="row clearfix">
                    <div class="col-md-4">
                        <img style="max-width: 250px" src="{{asset('storage/' . $diapers->image)}}" alt="">
                    </div>
                    <div class="col-md-6">
                        <div>{{ $diapers->price }}$</div>
                        <div>{!! $diapers->content !!}</div>
                        <div>{!! $diapers->description !!}</div>
                    </div>
                </div>
            </div>
            <hr>
