...
<div class="clearfix containers">
            ...
            @foreach($diapers as $diaper)
                <div class="clearfix backgroundWhite" style="padding-left: 100px ; padding-top: 20px; padding-bottom: 20px">
                    ...
                    <div class="row clearfix">
                        <div class="col-md-4">
                            <a href="{{ route('client.diapersShow', $diaper->id) }}"><img style="max-width: 250px" src="{{asset('storage/' . $diaper->image)}}" alt=""></a>
                        </div>
                        <div class="col-md-6">
    ...
    <div class="clearfix">
        <a href="{{ route('client.index') }}" class="btn btn-primary" style="margin-bottom: 10px; margin-left: 10px">{{ trans('<< Back') }}</a>
    </div>
</div>
